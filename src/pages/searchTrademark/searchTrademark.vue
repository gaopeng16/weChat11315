<template>
  <div class="search-body">
    ...
    <div class="search-group">
      <i-row>
        <i-col span="19">
          <input v-model="keyWord" class="search-input" type="text" placeholder="请输入注册号、商标名称、企业名称">
        </i-col>
        <i-col span="5">
    ...
    <div v-if="isGoSearch" class="search-result">
      ...
      >
        <i-row i-class="lh50">
          ...
          <i-col span="6">申请日期：</i-col>
          <i-col span="17" i-class="font-click">{{item.applicationDate}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">公司名称：</i-col>
          <i-col span="17" i-class="font-click">{{item.companyName}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">商标名称：</i-col>
          <i-col span="17" i-class="font-click">{{item.trademarkName}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">申注册号：</i-col>
          <i-col span="17" i-class="font-click">{{item.trademarkCode}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">类别：</i-col>
          <i-col span="17" i-class="font-click">{{item.trademarkType}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">状态：</i-col>
          <i-col span="17" i-class="font-click">{{item.state}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">商标图片：</i-col>
          <i-col span="17">
              ...
              if (res.data.data.counts > 0) {
                ...
                const searchList = res.data.data.list.map(function(item) {
                  if (item.applicationDate) {
                    item.applicationDate = utils.formatTime(
