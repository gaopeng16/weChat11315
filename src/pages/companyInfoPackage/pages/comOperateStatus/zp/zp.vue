<template>
  <div class="default-bg min-height100">
    <ToDepthSearch
      :url="'/pages/companyInfoDepthPackage/pages/comOperateStatus/zp/main'"
      v-if="total <= 0"
    ></ToDepthSearch>
    <div v-else>
      <DepthSearch :url="'/pages/companyInfoDepthPackage/pages/comOperateStatus/zp/main'"></DepthSearch>
      ...
      <div
        ...
        @click="developmentRecruitDetail(item)"
      >
        <div class="lh50">
          <span class="font-click">{{item.positionName}}</span>
        </div>
        <div class="lh50 red">
          薪资：
        ...
        <div class="lh50">
          招聘人数：
          <span class="font-click">{{item.nums}}</span>
        </div>
        <div class="lh50">
          所在城市：
...
export default {
  ...
  methods: {
    ...
    developmentRecruitDetail(item) {
      store.commit("setDevelopmentRecruitDetailData", item);
      wx.navigateTo({
        url: "/pages/companyInfoPackage/pages/comOperateStatus/zpDetail/main"
      });
    }
  },
  onPullDownRefresh() {
