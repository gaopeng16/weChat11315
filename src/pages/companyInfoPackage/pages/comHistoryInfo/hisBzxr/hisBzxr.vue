<template>
  <div class="default-bg min-height100">
    <ToDepthSearch
      :url="'/pages/companyInfoDepthPackage/pages/comHistoryInfo/hisBzxr/main'"
      v-if="total <= 0"
    ></ToDepthSearch>
    <div v-else>
      <DepthSearch :url="'/pages/companyInfoDepthPackage/pages/comHistoryInfo/hisBzxr/main'"></DepthSearch>
...
export default {
  ...
  methods: {
    init(init) {
      ...
      this.$http
        ...
        .then(res => {
          console.log("res-->", res);
          if (res.data.code == 0) {
            const result = res.data.data.pastZhixing;
            if (
    ...
    historyHxZhixingDetail(item) {
      ...
      wx.navigateTo({
        url: "/pages/companyInfoPackage/pages/comHistoryInfo/hisBzxrDetail/main"
      });
    }
  },
  onPullDownRefresh() {
