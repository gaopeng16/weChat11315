    ...
    <div v-if="isGoSearch" class="search-result">
      ...
      >
        <i-row i-class="lh50">
          ...
          <i-col span="6">登记日期：</i-col>
          <i-col span="17" i-class="font-click">{{item.registrationDate}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">软件全称：</i-col>
          <i-col span="17" i-class="font-click">{{item.softwareName}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">软件简称：</i-col>
          <i-col span="17" i-class="font-click">{{item.softwareAbbreviation}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="5" offset="1">登记号：</i-col>
          <i-col span="18" i-class="font-click">{{item.registrationCode}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="5" offset="1">分类号：</i-col>
          <i-col span="18" i-class="font-click">{{item.classificationCode}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="5" offset="1">版本号：</i-col>
          <i-col span="18" i-class="font-click">{{item.version}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">著作权人：</i-col>
          <i-col span="17" i-class="font-click">{{item.copyrightOwner}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="8" offset="1">著作权人国籍：</i-col>
          <i-col span="15" i-class="font-click">{{item.copyrightOwnerNationality}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="8" offset="1">首次发表日期：</i-col>
          <i-col span="15" i-class="font-click">企业选择不公开</i-col>
        </i-row>
      </div>
    </div>
    <!-- 没有搜索到数据显示的部分 -->
