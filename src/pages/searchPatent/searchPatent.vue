<template>
  <div class="search-body">
    ...
    <div class="search-group">
      <i-row>
        <i-col span="19">
          <input v-model="keyWord" class="search-input" type="text" placeholder="请输入专利名、专利号或公司名称">
        </i-col>
        <i-col span="5">
    ...
    <div v-if="isGoSearch" class="search-result">
      ...
      >
        <i-row i-class="lh50">
          ...
          <i-col span="6">公司名称：</i-col>
          <i-col span="17" i-class="font-click">{{item.companyName}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">专利名称：</i-col>
          <i-col span="17" i-class="sub-content">{{item.patentName}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">发明人：</i-col>
          <i-col span="17" i-class="sub-content">{{item.inventor}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">申请公布号：</i-col>
          <i-col span="17" i-class="sub-content">{{item.classificationCode}}</i-col>
        </i-row>
        <i-row i-class="lh50">
          <i-col span="6" offset="1">地址：</i-col>
          <i-col span="17" i-class="sub-content">{{item.address}}</i-col>
        </i-row>
      </div>
    </div>
    <!-- 没有搜索到数据显示的部分 -->
